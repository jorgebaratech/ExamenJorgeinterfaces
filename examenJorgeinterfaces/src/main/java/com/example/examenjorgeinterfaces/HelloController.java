package com.example.examenjorgeinterfaces;
...
public class HelloController {
    ...
    public void initialize() {
        ...
        // Add three sample students
        alumnos.add(new Alumno(null, "Juan", "Pérez", 8.0, 7.0, 9.0, 6.0, 7.0, 8.0, 7.0, calcularMedia(8.0, 7.0, 9.0, 6.0, 7.0, 8.0, 7.0)));
        alumnos.add(new Alumno(null, "María", "González", 7.0, 6.0, 8.0, 9.0, 6.0, 7.0, 8.0, calcularMedia(7.0, 6.0, 8.0, 9.0, 6.0, 7.0, 8.0)));
        alumnos.add(new Alumno(null, "Carlos", "Rodríguez", 9.0, 8.0, 7.0, 8.0, 9.0, 6.0, 7.0, calcularMedia(9.0, 8.0, 7.0, 8.0, 9.0, 6.0, 7.0)));
        ...
        // Configure spinners to accept values between 0 and 10
